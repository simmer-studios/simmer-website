        ...
        <div className="flex h-full items-center pr-5 lg:pr-0">
          <Link
            ...
            className={cn(
              ...
              {
                "bg-simmer-white/0 hover:text-simmer-white/95 lg:border-simmer-white":
                  theme === "dark"
              }
            )}
          >
          ...
          <Link
            ...
            className={cn(
              ...
              {
                "bg-black lg:border-simmer-white": theme === "dark"
              }
            )}
          >
            <FoodDome
              className={cn("h-[50px]", {
                "fill-simmer-white group-hover:fill-simmer-white/95":
                  theme === "dark"
              })}
            />
          </Link>
